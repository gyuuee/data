...
part_A_train_gt = os.path.join(root,'part_A_final/train_data_X','ground_truth')
...
for gt_path in gt_paths:
    ...
    h5_file_path = gt_path.replace('train_data_X', 'train_data_newmap1').replace('ground_truth', 'ground_truth')
