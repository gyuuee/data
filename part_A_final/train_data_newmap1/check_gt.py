...
def handleImage(filename, tar):
    ...
    gt_path1 = filename.replace('ground_truth','../train_data/ground_truth')
    # print(gt_path)
...
def main():
    if folderCheck(tar_folder): #and folderCheck(src_folder) and folderCheck(tar_folder_gt):
        ...
        gt_paths=[
            '/media/adminn/文档/ShanghaiTech_Crowd_Counting_Dataset/part_A_final/train_data_newmap1/ground_truth/IMG_115.h5',
            '/media/adminn/文档/ShanghaiTech_Crowd_Counting_Dataset/part_A_final/train_data_newmap1/ground_truth/IMG_17.h5',
            '/media/adminn/文档/ShanghaiTech_Crowd_Counting_Dataset/part_A_final/train_data_newmap1/ground_truth/IMG_110.h5'
        ]
